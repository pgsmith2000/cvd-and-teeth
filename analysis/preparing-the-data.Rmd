...
1. Removing participants under 50 eliminated `r nrow(BRFSS_d)-nrow(BRFSS_a)` records.
2. Removing participants with invalid dependent (outcome) variable data eliminated `r nrow(BRFSS_e)-nrow(BRFSS_d)` records.
3. Removing participants with invalid independent (exposure) variable data eliminated `r nrow(BRFSS_e)-nrow(BRFSS_d)` records.
