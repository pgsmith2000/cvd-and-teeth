...
3. Removing participants with invalid independent (exposure) variable data eliminated `r abs(nrow(BRFSS_e)-nrow(BRFSS_d))` records.

![Data Reduction](https://pgsmith2000.fithub.io/toothheart/output/figures/data_reduction.png "Data Reduction")
